...
class ThreeDEPN(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv3d(self.num_features*4, self.num_features*8, 4, stride=1)
        # 3D batch norm layers
        ...
        self.bn6 = nn.BatchNorm3d(self.num_features)
        self.relu = nn.ReLU()
    ...
    def forward(self, x):
        ...
        x = self.relu(self.bn4(self.tconv1(torch.cat((x,x_e4),dim=1))))

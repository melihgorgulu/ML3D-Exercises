...
class SimpleModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x = torch.reshape(x, (batch_size, 16))
        x = self.fcn(x)
...
def main(config):
    ...
    # Create Dataloaders
    train_dataset = SimpleDataset(split='train')  # TODO Instantiate Dataset in train split
    ...
    val_dataset = SimpleDataset(split='val')  # TODO Instantiate Dataset in val split
